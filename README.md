...
Javascript mono repo with hoisted dependencies, e.g. when using [Yarn Workspaces](https://yarnpkg.com/lang/en/docs/workspaces/), [pnpm workspaces](https://pnpm.io/workspaces), or npm workspaces.
...
experience. The plugin also works with pnpm workspaces and npm workspaces by automatically adapting to the package manager's structure. Not using nohoist saves wasting disk space and also accidentally including
